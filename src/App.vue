...
<template>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
          ...
          <p class="fst-italic">
            Actualmente trabajo como un Desarrollador Web para la Universidad de Ciencias y Artes de Chiapas.
          </p>
          <div class="row">
            <div class="col-lg-6">
              <ul>
          ...
          <p>
            He realizado diferentes funciones, así como proyectos con diferentes tecnologías.
          </p>
        </div>
      </div>
    </div>
  ...
  <section id="facts" class="facts">
    <div class="container">
      <div class="section-title">
        <h2>Datos</h2>
        <p>Estas son las estadisticas de todos mis proyectos</p>
      </div>
  ...
  <section id="skills" class="skills section-bg">
    <div class="container">
      <div class="section-title">
        <h2>Habilidades</h2>
        <p>A continuación estas son todas las tecnologías que he utilizado para todos mis proyectos</p>
      </div>
  ...
  <section id="portfolio" class="portfolio section-bg">
    <div class="container">
      <div class="section-title">
        <h2>Portafolio</h2>
        <p>Dentro de mis 12 años de experiencia he desarrollado como freelance una página web y una app; como
